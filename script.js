...
function dragonStatus(){
    if (food > 75 && water > 75 && health > 75) {
        document.querySelector(".dragonStates").src="https://pierrea44.github.io/TamagotiTeam/Dragon Tamagotchi/Normal.gif"
        ...
        document.querySelector(".dragonStates").src="https://pierrea44.github.io/TamagotiTeam/Dragon Tamagotchi/Sick.gif"
        ...
        document.querySelector(".dragonStates").src="https://pierrea44.github.io/TamagotiTeam/Dragon Tamagotchi/Sad.gif"
...
function gameOver(){
    ...
    if (health <= 0){
        document.querySelector(".dragonStates").src="https://pierrea44.github.io/TamagotiTeam/Dragon Tamagotchi/dragonGameOver.png"
        gameStart = "false";
